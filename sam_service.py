...
@app2.route('/api/calculate_price_info', methods=['GET'])
...
@app2.route('/api/calculate_price', methods=['POST'])
def calculate_price():
    try:
        data = request.json
...
if __name__ == '__main__':
     app2.run(host='0.0.0.0', port=80, debug=True)  # Замените '0.0.0.0' на желаемый IP-адрес
